  ...
  return (
    <div className="min-h-screen w-full bg-[#0b0f19] flex flex-col justify-between overflow-x-hidden text-gray-300 font-sans">
      ...
      <main className="flex-grow flex flex-col items-center justify-center px-4 py-8">
        ...
        {/* Card Container */}
        <div className="w-full max-w-[950px] bg-[#111827] border border-gray-800 rounded-2xl shadow-2xl flex flex-col overflow-hidden">
          ...
          <div className="bg-[#161f30]/40 border-t border-gray-800 px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <button
              type="submit"
              className="w-full sm:w-auto px-5 py-2.5 bg-rose-600 hover:bg-rose-500 text-white rounded-xl text-[13px] font-bold flex items-center justify-center gap-2 cursor-pointer transition-colors duration-200 shadow-lg shadow-rose-600/10 active:scale-[0.98]"
            >
              <span>★</span>
